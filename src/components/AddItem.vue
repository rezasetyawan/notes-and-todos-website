  ...
  <section class="flex justify-center items-center my-5">
    <div class="p-2 shadow-xl rounded-lg flex justify-between min-w-[90%] sm:min-w-[70%] lg:min-w-[50%]">
      <input
        ...
        class="focus:outline-none p-1 mr-5 text-slate-600 placeholder:text-slate-600 w-full"
        @input="triggerNoteForm"
        @click="triggerNoteForm"
      />
      <button class="p-2" @click="triggerTodoForm">
        <svg
          class="w-7 h-7"
          viewBox="0 0 24 24"
          version="1.1"
